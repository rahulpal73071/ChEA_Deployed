...
export default function Card({ image, name, position, phone, email, instagram, linkedin }) {
  ...
  return (
    <div
      className="relative group w-64 h-80 rounded-xl overflow-hidden shadow-[0_0_20px_#a855f7] transform transition-transform duration-300 
                 hover:scale-110 active:scale-110 touch-manipulation select-none"
      data-aos="fade-left"
    >
      {/* Image */}
